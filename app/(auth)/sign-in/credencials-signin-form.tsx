...
import { signInWithCredencials } from "@/lib/actions/user.action";
import { useSearchParams } from "next/navigation";
const CredencialsSignInForm = () => {

    const [data, action] = useActionState(signInWithCredencials, {
        success: false,
        message: ''
    });
...
export default CredencialsSignInForm;